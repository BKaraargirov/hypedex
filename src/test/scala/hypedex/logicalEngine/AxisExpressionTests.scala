...
import hypedex.logicalEngine.model.{Equals, GreaterThan, GreaterThanEqual, LessThan, LessThanEqual, LowerBound, UpperBound, AxisExpression}
import org.scalatest.{FlatSpec, Matchers}

import scala.collection.immutable.SortedSet

class AxisExpressionTests extends FlatSpec with Matchers {
  "By default value ranges" should "be from negative to positive infinity" in {
    val valueRange = AxisExpression()
    val expectedResult = AxisExpression(AxisSlice(
